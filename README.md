...
```
- To get PINECONE_INDEX_NAME  > Go to Pinecone--> INDEXES --> Create index  , the index dimensions should be Dimensions (because thats what the OpenAI Embeddings Endpoint uses)
